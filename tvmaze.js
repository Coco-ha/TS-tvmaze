        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    result = response.data.map(function (showDetails) { return ({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    response = _a.sent();
                    console.log('***response', response);
                    result = response.data.map(function (episode) { return ({
                        id: episode.id,
                        name: episode.name,
